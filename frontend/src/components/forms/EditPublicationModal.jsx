          ...
          >
            ...
            <div className="flex items-center justify-between p-5 border-b border-slate-100 bg-white/80 backdrop-blur-md sticky top-0 z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-slate-800 leading-tight">Edit Publication</h2>
                  <p className="text-xs font-medium text-slate-500">Update the publication details</p>
                </div>
              </div>
              <button
                onClick={onClose}
